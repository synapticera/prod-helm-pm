...
const moduleData = [
  [
    {
      text: "Module",
      options: { bold: true, color: COLORS.white, fill: COLORS.darkNavy }
    },
    {
...
const pillars = [
  {
    title: "1. AI-Native\nArchitecture",
    desc: "Built for agents from day one, not bolted-on legacy tech"
  },
  {
    title: "2. Platform\nIndependence",
    desc: "Works across Salesforce, Microsoft, SAP, custom systems"
  },
  {
    title: "3. Data Network\nEffects",
    desc: "Fleet learning from peer benchmarks drives continuous improvement"
  },
  {
    title: "4. First-Mover\nAdvantage",
    desc: "Establish brand leadership before category saturation"
  }
];
...
console.log(
  "[9/15] Creating table slide: Unit Economics & Path to Profitability..."
);
...
slide.addText(
  "Go-to-Market Strategy: Vertical Specialization Then Horizontal Scaling",
  {
    x: 0.5,
    y: 1.0,
    w: 9,
...
const phases = [
  {
    ...
    bullets: [
      ...
      "Vertical: Fortune 1000 in Financial Services",
      "Land & expand within installed base"
    ]
  },
  {
    title: "Phase 2: Multi-Cloud\n(2027-2028)",
    bullets: [
      "Microsoft Dynamics + custom CRM",
      "Expand to mid-market (500-2000 employees)",
      "Cross-vertical momentum"
    ]
  },
  {
    title: "Phase 3: Horizontal\n(2028+)",
    bullets: [
      "Enterprise and SMB horizontally",
      "New verticals: Healthcare, Retail, Manufacturing",
...
console.log(
  "[11/15] Creating content slide: Expansion & Retention Strategy..."
);
...
slide.addText(
  "MVP status • Beta users/pilots • Signups/waitlist • Early revenue/LOIs • Customer testimonials • Case studies • Usage metrics",
  {
    x: 0.5,
    y: 3.2,
    w: 9,
...
slide.addText(
  "Q1 2026 • Q2-Q3 2026 • Q4 2026-Q2 2027 • 2027+ long-term vision",
  {
    x: 0.5,
    y: 3.2,
    w: 9,
...
slide.addText(
  "Funding amount • Round structure • Use of funds • Key milestones • Runway • Series A timing",
  {
    x: 0.5,
    y: 3.2,
    w: 9,
...
slide.addText(
  'Establish Helm as the dominant "Executive Agent" platform, enabling service leaders globally to orchestrate AI with confidence, governance, and continuous improvement.',
  {
    x: 0.5,
    y: 2.3,
    w: 9,
