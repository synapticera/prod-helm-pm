    ...
    <div id="main-frame-error" class="interstitial-wrapper ">
      <div id="main-content">
        ...
        <div id="main-message">
          ...
          <!--?lit$575222260$-->
            <p>No webpage was found for the web address: <strong>https://docs.mindziestudio.com/user-management/service-accounts/page.md</strong></p>
          

          <!--?lit$575222260$-->

          <div class="error-code"><!--?lit$575222260$-->HTTP ERROR 404</div>
      ...
      <div id="buttons" class="nav-wrapper suggested-right">
        <div id="control-buttons">
          <!--?lit$575222260$-->
            <button id="reload-button" class="blue-button text-button" data-url="https://docs.mindziestudio.com/user-management/service-accounts/page.md">
              <!--?lit$575222260$-->Reload
            </button>
    ...
    <!--?lit$575222260$-->
      <div id="sub-frame-error">
        <!-- Show details when hovering over the icon, in case the details are
             hidden because they're too large. -->
        <div class="icon "></div>
        <div id="sub-frame-error-details">No webpage was found for the web address: <strong>https://docs.mindziestudio.com/user-management/service-accounts/page.md</strong></div>
      </div>
