    ...
    <div id="main-frame-error" class="interstitial-wrapper ">
      <div id="main-content">
        ...
        <div id="main-message">
          ...
          <!--?lit$269333380$-->
            <p>No webpage was found for the web address: <strong>https://docs.mindziestudio.com/how-to/overview/page.md</strong></p>
          

          <!--?lit$269333380$-->

          <div class="error-code"><!--?lit$269333380$-->HTTP ERROR 404</div>
      ...
      <div id="buttons" class="nav-wrapper suggested-right">
        <div id="control-buttons">
          <!--?lit$269333380$-->
            <button id="reload-button" class="blue-button text-button" data-url="https://docs.mindziestudio.com/how-to/overview/page.md">
              <!--?lit$269333380$-->Reload
            </button>
    ...
    <!--?lit$269333380$-->
      <div id="sub-frame-error">
        <!-- Show details when hovering over the icon, in case the details are
             hidden because they're too large. -->
        <div class="icon "></div>
        <div id="sub-frame-error-details">No webpage was found for the web address: <strong>https://docs.mindziestudio.com/how-to/overview/page.md</strong></div>
      </div>
