    ...
    <div id="main-frame-error" class="interstitial-wrapper ">
      <div id="main-content">
        ...
        <div id="main-message">
          ...
          <!--?lit$981287939$-->
            <p>No webpage was found for the web address: <strong>https://docs.mindziestudio.com/manage-service-accounts/page.md</strong></p>
          

          <!--?lit$981287939$-->

          <div class="error-code"><!--?lit$981287939$-->HTTP ERROR 404</div>
      ...
      <div id="buttons" class="nav-wrapper suggested-right">
        <div id="control-buttons">
          <!--?lit$981287939$-->
            <button id="reload-button" class="blue-button text-button" data-url="https://docs.mindziestudio.com/manage-service-accounts/page.md">
              <!--?lit$981287939$-->Reload
            </button>
    ...
    <!--?lit$981287939$-->
      <div id="sub-frame-error">
        <!-- Show details when hovering over the icon, in case the details are
             hidden because they're too large. -->
        <div class="icon "></div>
        <div id="sub-frame-error-details">No webpage was found for the web address: <strong>https://docs.mindziestudio.com/manage-service-accounts/page.md</strong></div>
      </div>
