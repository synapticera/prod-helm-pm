    ...
    <div id="main-frame-error" class="interstitial-wrapper ">
      <div id="main-content">
        ...
        <div id="main-message">
          ...
          <!--?lit$734453011$-->
            <p>No webpage was found for the web address: <strong>https://docs.mindziestudio.com/trim-text/page.md</strong></p>
          

          <!--?lit$734453011$-->

          <div class="error-code"><!--?lit$734453011$-->HTTP ERROR 404</div>
      ...
      <div id="buttons" class="nav-wrapper suggested-right">
        <div id="control-buttons">
          <!--?lit$734453011$-->
            <button id="reload-button" class="blue-button text-button" data-url="https://docs.mindziestudio.com/trim-text/page.md">
              <!--?lit$734453011$-->Reload
            </button>
    ...
    <!--?lit$734453011$-->
      <div id="sub-frame-error">
        <!-- Show details when hovering over the icon, in case the details are
             hidden because they're too large. -->
        <div class="icon "></div>
        <div id="sub-frame-error-details">No webpage was found for the web address: <strong>https://docs.mindziestudio.com/trim-text/page.md</strong></div>
      </div>
