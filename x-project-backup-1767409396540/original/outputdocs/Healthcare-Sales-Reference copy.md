...
- **Salesforce installed base**: 150,000+ customers, 1.2-1.5M Service Cloud agents
- **Opportunity**: 49% of Salesforce customers are SMBs, often under-optimized
...
- **Emerging category**: Process mining vendors targeting Salesforce (Apromore acquisition)
